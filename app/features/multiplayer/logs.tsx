                  ...
                  <div className="flex h-full items-start gap-2">
                    ...
                    >
                      <li className="rounded-md bg-black/25 px-3 py-2">
                        ...
                        fugiat cupidatat eu. Consectetur ex sint consequat
                        voluptate consequat adipisicing reprehenderit est
                        reprehenderit irure duis aliqua nostrud eu.
                      </li>
                      <li className="rounded-md bg-black/25 px-3 py-2">
                        Lorem ut amet veniam magna ullamco aliqua ex sit aute
                        non sunt sit ea sunt. Occaecat non sint aute mollit
                        occaecat quis eu enim fugiat pariatur pariatur cillum.
                        Amet sint est ut consectetur occaecat consectetur ea
                        sint aliqua proident veniam non. Laborum adipisicing
                        laborum amet tempor enim culpa minim dolor cupidatat
                        proident amet deserunt. Irure dolor ad irure nisi
                        officia dolore incididunt minim ex do commodo incididunt
                        ad sunt. Tempor dolor consectetur Lorem fugiat est
                        laborum et enim laboris ex occaecat. Magna qui
                        exercitation consectetur qui ullamco esse.
                      </li>
                      <li className="rounded-md bg-black/25 px-3 py-2">
                        Mollit ad in nisi non consectetur fugiat anim ipsum ex.
                        Aliquip tempor cillum velit sunt tempor anim fugiat.
                        Amet id irure adipisicing ut esse sit incididunt
                        reprehenderit aliquip sit exercitation. Enim nostrud in
                        esse eu labore elit amet voluptate proident in ut id
                        amet. Id aute deserunt excepteur minim id consequat.
                        Officia consequat voluptate consequat voluptate aliquip
                        ex ipsum est.
                      </li>
                    </Disclosure.Panel>
                    <Disclosure.Button className="opacity-75 transition hover:opacity-100">
                      <X />
                    </Disclosure.Button>
                  </div>
                </Transition.Child>
